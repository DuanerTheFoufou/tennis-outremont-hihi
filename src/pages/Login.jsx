      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              {isSignup ? 'Rejoignez la communauté Tennis Outremont' : 'Accédez à votre compte'}
            </motion.p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: isSignup ? 0.6 : 0.5, duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
            >
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Email
              </label>
            ...
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: isSignup ? 0.7 : 0.6, duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
            >
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Mot de passe
              </label>
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 ease-out disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          <motion.button
            ...
            whileTap={{ scale: loading ? 1 : 0.98 }}
            transition={{ duration: 0.2, ease: [0.25, 0.46, 0.45, 0.94] }}
            className="w-full bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-xl shadow-md hover:shadow-lg hover:border-gray-400 transition-all duration-300 ease-out disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
          >
          ...
          >
            <p className="text-gray-600">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                transition={{ duration: 0.2, ease: [0.25, 0.46, 0.45, 0.94] }}
                className="ml-2 text-green-600 hover:text-green-700 font-semibold transition-colors duration-300 ease-out"
              >
          ...
          >
            <Link
              to="/"
              className="text-gray-500 hover:text-gray-700 transition-colors duration-300 ease-out"
            >
              ← Retour à l'accueil
            </Link>
          </motion.div>
